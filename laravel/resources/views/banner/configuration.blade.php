...
<div class="container mt-3">
    ...
    <div class="row banner-preview-sticky" data-preview-variables-url="{{ route('banner.template.configuration.preview-variables', ['banner_template_id' => $banner_template->id]) }}">
        <div class="col-lg-6">
