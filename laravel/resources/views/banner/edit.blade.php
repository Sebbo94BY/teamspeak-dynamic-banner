        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('banner.update', ['banner_id' => $banner->id]) }}" class="row g-3 needs-validation" novalidate>
                        @method('patch')
                        @csrf

                        <div class="mb-3">
                            <label for="validationName" class="form-label">Name</label>
                            <input class="form-control" id="validationName" type="text" name="name" value="{{ old('name', $banner->name) }}" placeholder="e.g. My Banner or Games Banner" aria-describedby="nameHelp" required>
                        ...
                        <div class="mb-3">
                            ...
                            @if (old('random_rotation', $banner->random_rotation))
