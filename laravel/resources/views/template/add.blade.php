...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __("Add a template.") }}</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('template.save') }}" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="validationAlias" type="text" name="alias" value="{{ old('alias') }}" placeholder="e.g. Simple Template or Event Template" aria-describedby="aliasHelp" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="validationFile" type="file" accept="image/png, image/jpeg" name="file" value="{{ old('file') }}" aria-describedby="fileHelp" required>
