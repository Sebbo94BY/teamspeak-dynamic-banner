                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="validationHost" name="host" value="{{ old('host') }}" placeholder="e.g. my.teamspeak.local or 192.168.2.87" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="validationVoicePort" name="voice_port" min="1" max="65535" value="{{ old('voice_port', 9987) }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="validationServerQueryPort" name="serverquery_port" min="1" max="65535" value="{{ old('serverquery_port', 10022) }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="validationServerQueryUsername" name="serverquery_username" value="{{ old('serverquery_username') }}" placeholder="e.g. serveradmin" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" id="validationServerQueryPassword" name="serverquery_password" value="{{ old('serverquery_password') }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="validationClientNickname" maxlength="30" name="client_nickname" value="{{ old('client_nickname') }}" required>
