                ...
                <div class="modal-body">
                    <div class="col-lg-12">
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-11">
                                <input type="text" class="form-control" id="validationName" name="name" value="{{ old('name') }}" aria-describedby="validationNameHelp validationNameFeedback" placeholder="e.g. My Banner or Games Banner" required>
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-1">
                                <label class="col-form-label fw-bold" aria-labelledby="validationRandomRotationEnable">Enable</label>
                            </div>
