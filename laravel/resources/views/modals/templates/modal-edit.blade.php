                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-11">
                                <input type="text" class="form-control" id="validationAlias" name="alias" value="{{ old('alias', $templateModal->alias) }}"
                                       ...
                                       placeholder="e.g. Simple Template or Event Template" required>
                                <div id="validationAliasHelp" class="form-text">An alias for the template. (Only an information for you.)</div>
                            </div>
                            <div class="valid-feedback">{{ __("Looks good!") }}</div>
                            <div id="validationAliasFeedback-{{$templateModal->id}}" class="invalid-feedback">{{ __("Please provide a valid alias.") }}</div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="valid-feedback">{{ __("Looks good!") }}</div>
                            <div id="validationFileFeedback-{{$templateModal->id}}" class="invalid-feedback">{{ __("Please provide a valid file.") }}</div>
                        </div>
                    </div>
                </div>
