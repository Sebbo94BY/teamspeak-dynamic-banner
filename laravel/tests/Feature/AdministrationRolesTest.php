...
class AdministrationRolesTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function setUp(): void
    {
        ...
        $this->user->syncRoles('Roles Admin');
    }
    ...
    {
        $response = $this->get(route('administration.roles'));
    ...
    {
        $response = $this->actingAs($this->user)->get(route('administration.roles'));
        $response->assertStatus(200);
        $response->assertViewIs('administration.roles');
    }
}
